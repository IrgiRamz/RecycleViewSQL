...
class AddUpdateRecordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isEditMode){
            ...
            edt_lahir.setText(phone)
            edt_asal.setText(email)
            edt_informasi.setText(dob)
    ...
    private fun inputData() {
        ...
        phone =""+edt_lahir.text.toString().trim()
        email = ""+edt_asal.text.toString().trim()
        dob = ""+edt_informasi.text.toString().trim()
